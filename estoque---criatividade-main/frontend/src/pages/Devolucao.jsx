...
export default function Devolucao(){
    ...
    return(
        ...
        >
            <div className='
               w-full max-w-xl
               bg-white rounded-3x1
               shadow-2x1 overflow-hidden
            ...
            '>
                ...
                '>
                   ...
                   <div>
                       <h1 className='text-3x1 font-bold'>Devolução de Itens</h1>
                       <p className='text-green-100 mt-1'>Sistema de Almoxarifado</p>
                   </div>
                </div>
            </div>
            {/* FORM */}
